...
![Trunk-based deployment process explanation.](/img/blog/git-separate/trunk-based-deployment.jpg)
...
![Git rebase explanation](/img/blog/git-separate/git-rebase.jpg)
...
![screenshot of Github pull request with many commits.](/img/blog/git-separate/big-pr-screenshot.jpg)
...
![Screenshot of terminal use git cherry-pick to separate commit.](/img/blog/git-separate/git-commit-screenshot.jpg)
...
![Screenshot of terminal use git rebase.](/img/blog/git-separate/git-rebase-branch-screenshot.jpg)
...
![Screenshot of Github pull request with fewer commits that are removed by git rebase and cherry-pick.](/img/blog/git-separate/smaller-pr-screenshot.jpg)
