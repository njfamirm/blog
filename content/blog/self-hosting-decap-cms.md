...
summary: "Learn to self-host the Decap CMS backend, formerly Netlify-CMS, without relying on external services. This step-by-step guide simplifies setting up a git-based CMS for static site generators, perfect for those seeking an independent and streamlined content management system."
date: 2023-08-18
tags:
  - decap-cms
  - netlify-cms
...
![Create Oauth app on Github for Decap CMS](/img/blog/self-hosting-decap-cms/create-oauth-screenshot.jpg)
...
![Create client ID and secret ID in Github OAuth app](/img/blog/self-hosting-decap-cms/oauth-setting-screenshot.jpg)
