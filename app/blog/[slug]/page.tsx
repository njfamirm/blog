    ...
    <div className="min-h-screen">
      ...
      <article className="container mx-auto px-6 py-16">
        ...
        <div className="max-w-2xl mx-auto mt-24 pt-12 border-t border-border">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 bg-foreground text-background px-6 py-3 font-mono text-sm uppercase tracking-wider hover:opacity-90 transition-opacity"
          >
            Read More Articles
          </Link>
        </div>
